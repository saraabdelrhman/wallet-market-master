...
<h2 className='fw-bold'>Report</h2>
<Link to={'/admin/newreport'}><button style={{backgroundColor:'#377BF7',color:'white',borderRadius:'50px', padding:'10px',border:'0px'}} >Add Report</button></Link>
</div>
